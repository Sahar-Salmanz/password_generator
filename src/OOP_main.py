...
def test_random_password_generator():
    random_gen = RandomPassword(length=16, include_numbers=True, include_symbols=True)
...
def test_memorable_password_generator():
    memorable_gen = MemorablePassword(num_of_words=4, separator='_', capitalize=True)
